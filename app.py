...
# --- 4. 결과 리포트 (풍부한 분석 유지) ---
    ...
    if diff > 0.1:
        res = "분석적 과학 중심 기질"
        long_desc = "당신은 문제를 논리적으로 구조화하고, 원인과 결과를 따져가며 이해하는 경향이 강합니다. 명확한 기준과 검증 가능한 설명을 선호하며, 복잡한 현상을 분석적으로 바라보는 데 강점이 있습니다!  ※ 본 결과는 반응 경향을 바탕으로 한 참고용 분석이며, 개인의 능력이나 적성을 단정하지 않습니다."
    elif diff < -0.1:
        res = "통찰적 인문 중심 기질"
        long_desc = "당신은 현상을 사람과 맥락 중심으로 이해하려는 경향이 큽니다. 의미, 가치, 해석의 다양성을 중요하게 여기며, 이야기와 관점의 차이를 통해 문제를 바라보는 데 강점을 보입니다!  ※ 본 결과는 반응 경향을 바탕으로 한 참고용 분석이며, 개인의 능력이나 적성을 단정하지 않습니다."
    else:
        res = "균형 잡힌 창의적 융합 기질"
        long_desc = "당신은 논리와 해석을 상황에 맞게 함께 활용하는 경향이 있습니다. 하나의 관점에 고정되기보다, 문제의 성격에 따라 과학적 분석과 인문학적 이해를 유연하게 오가는 타입입니다!  ※ 본 결과는 반응 경향을 바탕으로 한 참고용 분석이며, 개인의 능력이나 적성을 단정하지 않습니다."
